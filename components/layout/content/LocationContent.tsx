      ...
      <FormWithTitle title={"오시는 길"}>
        <div className="flex flex-col items-center space-y-3">
          <div className="text-center text-16 leading-[30px]">
            {LineBreaker(
              `${location.place} ${location.hall}\n${location.address}`
            )}
          </div>
          <p className="text-15">031-333-6114</p>
        </div>
        <MapLayout
        ...
        <div className="flex w-full flex-col items-center space-y-4 px-6 sm:px-8">
            ...
            lineItems={[
              {
                ...
                text: "일반 : 30, 31, 100, 331",
              },
              {
                color: BUS_COLORS.ganseon,
                text: "간선 : 302, 303, 320, 333, 343, 345, 350, 360, 422",
              },
              {
              ...
              },
              {
                ...
                text: "직행 : 500-1, 1009, 1112, 1117, 1650",
              },
            ]}
            descriptions={[
          ...
          <WayToComeForm
            title="🅿️ 주차"
            descriptions={[
              "지하2층~지하5층 400대, 외부 300대 가능\n\n하객 2시간 무료 주차\n주차권은 연회장 입구 안내데스크에서 발행해 드립니다.",
            ]}
          />
        </div>
      </FormWithTitle>
